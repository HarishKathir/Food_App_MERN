    ...
    <section className='max-padd-container pt-20 py-4'>
      <div className='py=10'>
        <table className='w-full'>
          <thead>
            <tr className='border-b boder-slate-900/20 text-gray-30 regular-14 xs:regular-16 text-start py-12'>
            ...
            {all_products.map((product) => {
              if(cartItems[product._id] > 0){
                return(
                  ...
                  <td className='p-1'>
                    <img src={URL+"/images/"+product.image} alt="Product Image" height={43} width={43} className='rounded-lg ring-1 ring-slate-900/5 m-1'/>
                  </td>
                  <td className='p-1'>
        ...
        <div className='flex flex-col xl:flex-row gap-20 mt-20'>
          ...
          <div >
            <div className='flex flex-1 flex-col gap-8'>
              ...
              <div className='flexBetween h-[2.8rem] bg-primary ring-1 ing-slate-900/10 w-full max-w-[488px] rounded'>
